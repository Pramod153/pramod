    ...
    <div class="container">
        ...
        <div class="content">
            <div class="cards">
                <div class="card">
                    <div class="box">
                        <a href="accoutn.php"><h3>Accounts</h3></a>
                ...
                <div class="cards">
                    <div class="box">
                    <a href="subsidylist.php">  <h3>Bills-subsidy</h3></a>

                    </div>
                </div>
                <div class="card">
                    <div class="box">
                    <a href="credit.php">  <h3>Credit</h3></a>
            ...
            <div class="cards">
                <div class="cards">
                    <div class="box">
                    <a href="billin.php"><h3>Bills-inward</h3></a>

                    </div>
                </div>
                <div class="card">
                    <div class="box">
                    <a href="billoutwardlist.php"><h3>Bills-Outward</h3></a>
