...
<body>
    ...
    <div class="body1">
        <div class="col-md-3" style="flex: initial;">
            ...
            <section id="menu">
                <h3 style="padding-top:40px; text-align:center; font-weight:bold; font-size:25px; color:white; ">KLE SOCEITY</h3>
                <div class="items">
                    ...
                    <li id="stock" class="stock" active>
                        <i class="fa-solid fa-cubes" style="color:white;"></i><a  style="margin-left: 5px;">Staff/admin</a>
                        <ul class="dropdown-menu" id="billsSubMenu" >
                            <li><a href="staffcreate.php">Create</a></li>
                            <li><a href="viewstaff.php">View</a></li>
                        </ul>
                    </li>
                    <li id="stock" class="stock" active>
                        <i class="fa-solid fa-cubes" style="color:white;"></i><a  style="margin-left: 5px;">Products</a>
                        <ul class="dropdown-menu" id="billsSubMenu" >
                    ...
                    <li id="subsidy" class="subsidy">
                        <i class="fa-solid fa-money-bill-wheat" style="color:white;"></i> 
                        <a href="studentdet1.php" style="margin-left: 5px;">Students Details</a>
                    </li>
                    ...
                    <li id="report" class="report">
                        ...
                        <a href="report.php" style="margin-left: 5px;" >Report</a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="report.php">Stock</a></li>
                        </ul>
                    </li>
                    <!-- <li id="subsidy" class="subsidy">
                        <i class="fa-solid fa-money-bill-wheat" style="color:white;"></i> <a href="password.html"
                            style="margin-left: 5px;">Change Password</a>
                    </li> -->

                    <li id="logout"><i class="fa-solid fa-right-from-bracket" style="color:white;"></i> <a href="index.php"
